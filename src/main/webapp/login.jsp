							...
							<div class="dlcLeft">
								<div class="frmItem">
									...
									<div class="frm_controls">
										<input id="username" type="text" class="frm-controlM" name="username" value="service@diaowen.net" >
								...
								<div class="frmItem">
									...
									<div class="frm_controls">
										<input type="password"  name="password" id="passwordInput"  class="frm-controlM" value="123456" />
